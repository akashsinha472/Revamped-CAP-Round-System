...
class ReRegistration():
       def __init__(self, master):
              self.master = master
              self.master.title('RE-REGISTRATION')
              ...
              #========================================================Variables=====================================================================
               ...
               #==========================================================Functions====================================================================
                     ...
                     def Search_and_Update():
                            ...
                            if message[3]=='r':
                                tkinter.messagebox.showinfo("Registration System","You have successfully re-registered.\nYour password is: "+self.password.get()+"\n"+message)
                            else:
                     ...
                     self.Frame_1 = LabelFrame(self.Main_Frame, width = 600, height = 400, font = ('arial',15,'bold'), \
                                               relief = 'ridge', bd = 10, bg = 'light blue', text = 'RE-REGISTER ')
                     ...
                     self.btnSave = Button(self.Frame_3, text = 'RE-REGISTER', font = ('arial',17,'bold'), width = 12, command = Search_and_Update)
                     self.btnSave.grid(row = 0, column = 0, padx = 10, pady = 10)
                     self.btnExit = Button(self.Frame_3, text = 'BACK', font = ('arial',17,'bold'), width = 12, command = Exit)
